        ...
        <v-row>
          ...
          <v-col cols="12" md="6">
            ...
            <p>
              ...
              <span class="highlight">エンジニア</span
            ...
            <p>
              ...
              >を行いました。その過程で、これまで数時間かかっていた仕事を瞬時に終わらせることができるプログラムやシステムというものに
              <span class="highlight">計り知れない可能性</span
              >を感じると共に、徐々に
              <span class="highlight"
                >もっと多くの人の役に立つサービスを自らの手で作ってみたい</span
              >と考えるようになりました。そして、エンジニアとしてのキャリアを歩むことを決心しました。
            </p>
          ...
          <v-timeline-item color="#FB5D63">
            ...
            <div>
              ...
              <div>
                ...
                <span class="highlight"
                  >Google Apps
                  Scriptを独学して業務を自動化、効率化するツールを複数開発</span
                >しました。一部は
                <span
          ...
          <v-timeline-item color="#FB5D63">
            ...
            <div>
              ...
              <div>
                ...
                >という思いが強くなりました。人間関係も非常に良い職場で葛藤はありましたが、自らの夢を叶える為に転職することを決意しました。現在はエンジニアとしての転職を目指し、活動をする傍ら、毎日欠かさず学習に取り組んでいます。最近はインフラの知識が不足していることを痛感し、Linuxの学習を進めています。
              </div>
            </div>
          </v-timeline-item>
        </v-timeline>
      ...
      <div id="works" class="mx-4 mx-md-8 my-4">
        ...
        <v-row class="my-12">
          ...
          >
            ...
            >
              <v-card class="d-flex justify-center">
                <img width="100%" :height="isMobile ? windowSize.width / 1.6 : '600px'" src="./assets/canda.png" alt="canda" />
              </v-card>
            </v-dialog>
          </v-col>
          <v-col cols="12" md="6" class="mt-4 mt-md-0">
