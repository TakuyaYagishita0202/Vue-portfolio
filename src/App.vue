<template>
  <v-app>
    <v-navigation-drawer app v-model="drawer" :floating="true">
      <v-row justify="center">
        <v-avatar size="100" class="mt-8 mb-3">
          <img src="./assets/profile.png" alt="takuya" />
        </v-avatar>
        <v-list-item>
          <v-list-item-content>
        ...
        <v-row justify="center">
          <div class="mb-6">
            ...
            <v-btn
              icon
              color="white"
              href="mailto:yagishita0202@gmail.com"
              :data-cursor-hover="true"
            >
    ...
    <v-app-bar app color="transparent" flat dark>
      <v-app-bar-nav-icon color="#C4C4C4" :data-cursor-hover="true" @click.stop="drawer = !drawer"></v-app-bar-nav-icon>
    </v-app-bar>
      ...
      <div id="about" class="mx-4 mx-md-8 my-4">
        ...
        <v-row>
          <v-col class="d-flex justify-center" cols="12" md="6">
            <div>
              <v-img src="./assets/profile.png" max-width="100vw" width="420px" class="grey darken-4"></v-img>
            </div>
          </v-col>
          <v-col cols="12" md="6">
            ...
            <p>
              ...
              <span class="highlight">ソフトウェアエンジニア</span>(フロントエンドまたはバックエンド)への転職を目指し、2020年3月よりプログラミングの学習を精力的に行っております。
              <br />これまで学習した技術は以下の通りです。
              <br />
              <v-chip
            ...
            <p>
              ...
              <span
                class="highlight"
              >効率化</span>や
              <span class="highlight">自動化</span>を行いました。その過程で、これまで数時間かかっていた仕事を瞬時に終わらせることができるプログラムやシステムというものに
              <span
                class="highlight"
              >計り知れない可能性</span>を感じると共に、徐々に
              <span class="highlight">もっと多くの人の役に立つサービスを自らの手で作ってみたい</span>と考えるようになりました。そして、エンジニアとしてのキャリアを歩むことを決心しました。
            </p>
            <h2 class="mb-4">将来の夢は？</h2>
            <p>
              夢は
              <span class="highlight">多くの人の課題を解決するサービスを開発すること</span>です。学習を始めたばかりでまだまだ技術力もないペーペーですが、どんどん新しいことにチャレンジをして技術的な領域を広げ、将来は上流工程からサービスの開発・設計に携わることのできる人材へと成長していきたいです。
            </p>
          </v-col>
        </v-row>
      </div>
        ...
        <v-timeline :dense="isMobile">
          ...
          <v-timeline-item color="#FB5D63">
            ...
            <div>
              ...
              <div>
                高校卒業後は大阪市立大学に進学し、学業、サークル活動、アルバイトと充実した日々を過ごしました。また、語学の習得にも力を入れ、2018年3月には
                <span
                  class="highlight"
            ...
            <div>
              ...
              <div>
                ...
                <span
                  class="highlight"
                >過去最高月商</span>を記録。さらに
                <span class="highlight">楽天市場出店5万店舗の売り上げ上位100店舗</span>(上位0.2%)にランクインすることができました。
                <span class="highlight">業務改善</span>にも積極的に取り組み、
                <span class="highlight">
                  Google Apps
                  Scriptを独学して業務を自動化、効率化するツールを複数開発
                </span>しました。一部は
                <span
                  ...
                  data-cursor-hover
                  style="cursor:none"
                >Works</span>に掲載しておりますのでご興味がありましたら是非ご覧ください。
              </div>
            </div>
          </v-timeline-item>
          <v-timeline-item color="#FB5D63">
            ...
            <div>
              ...
              <div>
                プログラミングを独学して業務改善を行い、上司や部下に感謝された経験に非常にやりがいを感じ、
                <span
                  class="highlight"
                >もっとより多くの人の役に立つアプリケーションやサービスを開発してみたい</span>という思いが強くなりました。人間関係も非常に良い職場で葛藤はありましたが、自らの夢を叶える為に転職することを決意しました。現在はエンジニアとしての転職を目指し、活動をする傍ら、毎日欠かさず学習に取り組んでいます。最近はインフラの知識が不足していることを痛感し、Linuxの学習を進めています。
              </div>
            </div>
          </v-timeline-item>
        </v-timeline>
        ...
        <v-row class="my-12">
          ...
          >
            ...
            <v-dialog v-model="dialog.canda" :max-width="isMobile ? '100%' : '1000'">
              <v-card class="d-flex justify-center">
                <img
                  width="100%"
                  :height="isMobile ? windowSize.width / 1.6 : '600px'"
                  src="./assets/canda.png"
                  alt="canda"
                />
              </v-card>
          ...
          <v-col cols="12" md="6" class="mt-4 mt-md-0">
            ...
            <p>
              ...
              <br />
              <br />使用した主な技術：
              <br />HTML5 / CSS3 / Google Apps Script /
              Chatwork API
            </p>
          </v-col>
        </v-row>
        ...
        <v-row class="my-12">
          ...
          <v-col cols="12" md="6" class="mt-4 mt-md-0">
            ...
            <p>
              ...
              <br />
              <br />使用した主な技術：
              <br />Google Apps Script / LINE Messaging
              API
            </p>
          </v-col>
        </v-row>
      ...
      >
        ...
        <v-card :loading="loading">
          ...
          <v-card-subtitle class="pb-0">
            ...
            <br v-if="!isMobile" />につきましてはメール、またはこちらのフォームをご利用ください。
          </v-card-subtitle>
...
export default {
  ...
  data: () => ({
    ...
    learned: [
      ...
      { name: "React", icon: "fab fa-react", color: "#61dcfc" },
      { name: "PHP", icon: "fab fa-php", color: "#777BB3" },
      { name: "Laravel", icon: "mdi-laravel", color: "#FF3528" },
      { name: "Node.js", icon: "fab fa-node-js", color: "#066F03" },
